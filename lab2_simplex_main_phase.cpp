...
bool SimplexAlgorithm(const size_t& n, const size_t& m, vector& c, Matrix& A, vector& b, vector& x, std::vector<size_t>& jb)
{
...
int main()
{
	...
	try
	{
		bool is_has_solve = SimplexAlgorithm(n, m, c, A, b, x, jb);
